...
open class CNCVersePlugin : Plugin() {
    override fun load(context: Context) {
        ...
        val sharedPref = context.getSharedPreferences("CNCVerseStudiosM", Context.MODE_PRIVATE)
        val studioOptions = listOf(
            StudioOption("studio_disney", "DisneyM", "disney"),
            StudioOption("studio_marvel", "MarvelM", "marvel"),
            StudioOption("studio_starwars", "Star WarsM", "starwars"),
            StudioOption("studio_pixar", "PixarM", "pixar")
        )
